  ...
  return (
    <main>
      <div class="history row justify-content-around border-bottom text-center">
        <div class="col-4 pt-3 pb-1 border-bottom border-dark">
      ...
      <section>
        <div className="container">
          <div class="sub-title-box text-center">
            <h2 class="sub-main__title mb-4 mt-5">최근 본 상품</h2>
            <p class="mb-5">최근 3일간 최대 20개의 상품이 표시됩니다</p>
          </div>
          <table class="cart-table mb-5" style={{ width: '100%' }}>
            ...
            <tbody>
              <HistoryItem item={itemList[1]} />
              <HistoryItem item={itemList[2]} />
            </tbody>
          </table>
        </div>
      </section>
